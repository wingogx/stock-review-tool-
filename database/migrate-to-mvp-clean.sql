...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE '已添加 market_activity 字段到 market_sentiment 表';
    ELSE
        RAISE NOTICE 'market_activity 字段已存在';
    END IF;
END $$;
